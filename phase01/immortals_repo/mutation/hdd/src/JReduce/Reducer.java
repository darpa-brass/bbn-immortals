...
public class Reducer {
    ...
    String buildcommand;
    BuildAndRunAbstract finalBuildAndrunCommand;
    public Reducer(JavaMethod javaMethod, ITester tester, int currentDepthLevel, String buildCommand){
    ...
    public void ReduceSequentical() throws ParseException {
        ...
        while (true) {
            try {
                ...
                BuildAndRun buildAndRun = new BuildAndRun(this.buildcommand, tester);
