...
"""
def create_application_instance(execution_path, application_configuration):
    ...
    if platform == 'android' or platform == 'android_emulator' or platform == 'android_docker' or platform == 'android_dynamicanalysis' or platform == 'android_staticanalysis':
        return androidapplication.AndroidApplication(execution_path, application_configuration)

    elif platform == 'java' or platform == 'java_local':
        return javaapplication.JavaApplication(execution_path, application_configuration)
    else:
...
"""
def create_platform_instance(execution_path, application_configuration):
    platform = application_configuration.deployment_platform_environment

    if platform == "android_emulator":
        return androidplatform_emulator.AndroidEmulatorInstance(execution_path, application_configuration)

    elif platform == "android_docker":
        return androidplatform_docker.AndroidDockerEmulatorInstance(execution_path, application_configuration)

    elif platform == "android_dynamicanalysis":
        return androidplatform_dynamicanalysis.AndroidDynamicAnalysisInstance(execution_path, application_configuration)

    elif platform == "android_staticanalysis":
        return androidplatform_staticanalysis.AndroidStaticAnalysisInstance(execution_path, application_configuration)

    elif platform == 'java_local':
        return javaplatform.JavaPlatform(execution_path, application_configuration)
    else:
