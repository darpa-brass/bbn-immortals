...
class ScenarioRunner:
    ...
    def __init__(self, scenario_identifier, do_wipe_environments, do_setup_environments, do_setup_applications, do_execute_scenario, do_display_ui):
        self.scenario_identifier = scenario_identifier
        self.do_wipe_environments = do_wipe_environments
    ...
    def _init_applications(self):
        ...
        for configuration_instance in deployment_applications:
            ...
            application_instance = platformhelper.create_application_instance(execution_path, configuration_instance, self.do_wipe_environments)
...
def main():
    ...
    do_environment_setup = args.setup_environment or args.force_setup_environment
    ...
    if args.list_scenarios:
        ...
        if scenario_identifier not in config.scenarios:
            ...
            runner = ScenarioRunner(scenario_identifier, do_wipe_environments, do_environment_setup, do_application_setup, do_execute_scenario, do_display_ui)
