 ...
 */
public class ByteCotifier implements ReadableObjectPipeInterface<CoTMessage> {
    ...
    private ReadableObjectPipeInterface<byte[]> previous;

    public ByteCotifier(ReadableObjectPipeInterface<byte[]> previous) {
