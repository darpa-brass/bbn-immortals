...
public class Dispatcher implements Runnable, WriteableObjectPipeInterface<byte[]>, ReadableObjectPipeInterface<byte[]> {

    private Selector selector;
    private SocketChannel socketChannel;
    private AtomicBoolean pendingWrite = new AtomicBoolean(false);
    private SparseArray<DispatchHandler> handlers = new SparseArray<DispatchHandler>(3);
