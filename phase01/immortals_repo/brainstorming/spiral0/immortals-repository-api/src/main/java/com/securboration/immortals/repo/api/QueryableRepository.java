 ...
 *
 */
public class QueryableRepository extends WritableRepository {

    public QueryableRepository(RepositoryConfiguration configuration) {
        super(configuration);
    }
     ...
     */
    public Model constructModelFromObject(Object immortalsObject){
    ...
    /**
     * DELETE all graphs, use with care
     */
