...
import com.securboration.immortals.maven.analysis.classes.JavaToOwl;
import com.securboration.immortals.maven.analysis.object.ObjectToOwl;
import com.securboration.immortals.maven.bytecode.DependencyWalkerClass;
...
public class AnalysisEntryPoint {
    ...
    public void analyze() throws ClassNotFoundException {
        ...
        {//TODO
            new JavaToOwl(context).analyze();
            new ObjectToOwl(context).analyze();
        }
