...
recCheck l = recUpdate l id

-- | Delete record entry.
recDelete :: Label -> Expr t -> Expr t
recDelete l e = Both (Sel l e) ("v","r") (Waste (Use "v") (Use "r"))

-- | Replace a record entry.
recReplace :: Label -> Expr t -> Expr t -> Expr t
recReplace l v e = Ext l v (recDelete l e)

-- | Update a record entry.
recUpdate :: Label -> (Expr t -> Expr t) -> Expr t -> Expr t
recUpdate l up e = Both (Sel l e) ("v","r") (Ext l (up (Use "v")) (Use "r"))
