...
//import mil.darpa.immortals.sourcecomposer.configuration.GsonHelper;
...
//
//
//    public ExecutionReport(@Nonnull AnalysisModuleConfiguration moduleConfiguration, @Nonnull AnalysisComparisonConfig analysisConfig) {
