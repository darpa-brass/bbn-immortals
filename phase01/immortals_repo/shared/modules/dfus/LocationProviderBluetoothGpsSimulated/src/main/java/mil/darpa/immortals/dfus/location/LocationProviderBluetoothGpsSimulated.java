...
import com.securboration.immortals.ontology.resources.gps.GpsReceiverBluetooth;
 ...
 */
//@Dfu(functionalityUri = Semantics.Functionality_LocationProvider_BluetoothGPS,
...
@DfuAnnotation(
        ...
        resourceDependencies = {
                GpsSatellite.class,
                GpsReceiverBluetooth.class
        }
)
public class LocationProviderBluetoothGpsSimulated {

    private static final String providerIdentifier = "LocationProviderBluetoothGpsSimulated";
    ...
    public void initialize(Context context) {
        ...
        try {
            ...
            Analytics.log(Analytics.newEvent(AnalyticsEventType.UnexepctedIgnorableError, providerIdentifier, "Error iterating over bluetoothdevices!"));
        }
    }
