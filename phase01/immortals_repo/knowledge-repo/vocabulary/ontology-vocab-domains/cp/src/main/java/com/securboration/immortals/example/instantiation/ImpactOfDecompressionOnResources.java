...
//
//@ConceptInstance
//public class ImpactOfDecompressionOnResources extends CauseEffectAssertion{
//    
//    public ImpactOfDecompressionOnResources(){
//        
//        this.setHumanReadableDescription(
//            "The removal of the Compressed property results in " +
...
//                "the removal of the Compressed property"
//                );
//            criterion.setCriterion(PropertyCriterionType.WHEN_PROPERTY_REMOVED);
...
//                "increases the consumption of memory"
//                );
//            impact1.setImpactOnResource(ResourceImpactType.INCREASES_CONSUMPTION_OF);
...
//                );
//            impact2.setImpactOnProperty(PropertyImpactType.DECREASES);
