...
public class MethodInstructionPrinter extends MethodVisitor {
    ...
    public MethodInstructionPrinter(
        ...
        this.traceVisitor = new TraceMethodVisitor(null,
                labelMappableTextifier);
    ...
    public void visitMethodInsn(int opcode, String owner, String name,
        ...
        if (visitInstruction()) {
            traceVisitor.visitMethodInsn(opcode, owner, name, desc,
                    isInterface);
        }
    }
    ...
    @Override
    public void visitTableSwitchInsn(int min, int max, Label d,
            Label... labels) {
        labelMappableTextifier.registerLabel(d);
        for (Label l : labels) {
            labelMappableTextifier.registerLabel(l);
     ...
     * visitTryCatchBlock | visitTryCatchBlockAnnotation | visitLocalVariable |
