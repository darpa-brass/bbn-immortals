...
import mil.darpa.immortals.annotation.dsl.ontology.resources.gps.properties.HighAccuracyProperty;
...
//TODO: for now it is a constraint of the dsl/parser that properties 
//       cant be nested inside the DFU annotations
@TrustedProperty
@HighAccuracyProperty
public class ExampleA_TrustedAccurateLocationProvider {
