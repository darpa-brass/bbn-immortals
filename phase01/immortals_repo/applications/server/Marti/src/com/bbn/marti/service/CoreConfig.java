...
public class CoreConfig extends UnicastRemoteObject implements CoreConfigInterface {
    ...
    void init() {
        try {
            ...
            log.error("Couldn't load " + CONFIG_FILE + ": " + e.getMessage());
        }
    ...
    public class ReadTcpConfigurationData extends AbstractOutputProvider<TcpInitializationData> {
