...
# from .androidplatform_emulator import AndroidEmulatorInstance
...
#
#                 for filepath2 in self.docker.files:
#                     if os.path.basename(filepath2) == 'ds_load_tracing_plugin.expect':
#                         logging.info('Loading droidscope tracing plugin...')
#                         cmd = ['expect', filepath2]
#                         logging.debug('EXEC: ' + str(cmd))
#                         self.docker.call(cmd)
#
...
#         self.emulator = AndroidEmulatorInstance(self.config.applicationDeploymentDirectory,
