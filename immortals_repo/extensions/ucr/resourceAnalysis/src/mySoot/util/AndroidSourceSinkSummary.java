...
//		}
	...
	public static void buildSourceSummary(){
		...
		sourceIndexes = new ArrayList<Integer>();
		sourceIndexes.add(ret);
		sourceSummary.put("<android.location.Location: double getLatitude()>", sourceIndexes);
		
		sourceIndexes = new ArrayList<Integer>();
		sourceIndexes.add(ret);
		sourceSummary.put("<android.location.Location: double getLongitude()>", sourceIndexes);
		
		sourceIndexes = new ArrayList<Integer>();
		sourceIndexes.add(ret);
		sourceSummary.put("<android.location.Location: double getAltitude()>", sourceIndexes);
