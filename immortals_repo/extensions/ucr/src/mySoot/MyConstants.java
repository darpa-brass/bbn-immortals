...
public interface MyConstants {
	...
	public static final String SIGNATURE_SEPERATOR = "|";
	
	// added for BBN
	public static final boolean DEBUG_SQL = true;
	public static final boolean INTRA_DATAFLOW = true;
	
	// third party libs
	public static final String JAVA = "rt.jar";
	public static final String THIRD_PARTY_LIBS = "Third_party_libs";
	
	public static final String ANDROID_24 = "android-24.jar";//7.0
	public static final String ANDROID_23 = "android-23.jar";//6.0
	...
	*/
	...
	public static final boolean FORWARD_DATAFLOW = false;
	public static final boolean BACKWARD_DATAFLOW = false;
	public static final boolean ENTRY_POINT_DISCOVERY= true;
	public static final boolean GLOBAL_API_GRPAH = false;
	public static boolean DFU_RESOURCE_ANALYSIS = true;
	public static boolean SQL_ANALYSIS = false;
