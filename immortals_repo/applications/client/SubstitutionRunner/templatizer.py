...
targetDirectory = "src-templates/main/"


def main():
    controlPointFile = "java/mil/darpa/immortals/modulerunner/MainActivity.java"
    targetTemplateFile = "java/mil/darpa/immortals/modulerunner/MainActivity.java"
        ...
        if deletionPointStartIdentifier in line:
            if replacementString is None:
                if line.count('{') == 1 and line.count('}') == 1:
                    ...
                    raise Exception(
                        "Expected two '\"' in the deleation start point to enclose the replacement text but found none!")
            else:
