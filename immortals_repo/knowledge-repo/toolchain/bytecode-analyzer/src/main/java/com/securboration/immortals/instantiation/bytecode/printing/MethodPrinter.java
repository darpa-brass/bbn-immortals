package com.securboration.immortals.instantiation.bytecode.printing;
...
public class MethodPrinter extends ClassVisitor {
    ...
    public static String print(MethodNode mn) {
        return print(mn, (AbstractInsnNode) null);
    }

    public static String print(MethodNode mn, AbstractInsnNode i) {
        return print(mn, i == null ? null : mn.instructions.indexOf(i));
    }

    private static String print(MethodNode mn, Integer instructionIndex) {
        ...
        LabelMappableTextifier labelAwareTextifier = new LabelMappableTextifier();

        MethodPrinter visitor = new MethodPrinter(mn.name, mn.desc,
                instructionIndex, labelAwareTextifier);
        c.accept(visitor);
     ...
     *            null = wildcard
     */
    private MethodPrinter(String methodName, String methodDesc,
            Integer instructionIndex) {
        this(methodName, methodDesc, instructionIndex,
                new LabelMappableTextifier());
    }

    private MethodPrinter(String methodName, String methodDesc,
            Integer instructionIndex, LabelMappableTextifier printer) {
        super(Opcodes.ASM5);
