...
import com.securboration.immortals.maven.analysis.object.ObjectNode;
import com.securboration.immortals.maven.analysis.object.ObjectPrinter;

public class Main {
    
    
    private static void test(Object o) throws IllegalArgumentException, IllegalAccessException{
        
        System.out.printf("about to print a %s\n", o);
        
        ObjectNode node = ObjectNode.build(o);
