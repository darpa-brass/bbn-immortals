...
<xsl:stylesheet xmlns:mdl="http://inetprogram.org/projects/MDL" xmlns:my="http://233analytics.com/my" xmlns:tmats="https://wsmrc2vger.wsmr.army.mil/rcc/manuals/106-11" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/1999/xhtml" version="2.0">
      ...
      <xsl:element name="NameValues" namespace="http://inetprogram.org/projects/MDL">
        ...
        <xsl:if test="not(/mdl:MDLRoot/mdl:MeasurementDomains/mdl:MeasurementDomain/mdl:DataOperations/mdl:DataOperation/mdl:GenericParameter/mdl:NameValue)">
          <xsl:element name="NameValue" namespace="http://inetprogram.org/projects/MDL">
            <xsl:attribute name="Name">autogenerated</xsl:attribute>
            <xsl:attribute name="Index">9999</xsl:attribute>
          </xsl:element>
        </xsl:if>
      </xsl:element>
    </xsl:copy>
  ...
  <xsl:template match="/mdl:MDLRoot/mdl:MeasurementDomains/mdl:MeasurementDomain/mdl:Measurements/mdl:Measurement">
    <xsl:copy>
      ...
      <xsl:element name="ProperName" namespace="http://inetprogram.org/projects/MDL">None</xsl:element>
    </xsl:copy>
  </xsl:template>
    ...
    <xsl:copy>
      ...
      <xsl:element name="DeviceStructure" namespace="http://inetprogram.org/projects/MDL">
        ...
        <xsl:element name="DeviceModule" namespace="http://inetprogram.org/projects/MDL">
          ...
          <xsl:element name="Manufacturer" namespace="http://inetprogram.org/projects/MDL">autogenerated</xsl:element>
          <xsl:element name="Model" namespace="http://inetprogram.org/projects/MDL">autogenerated</xsl:element>
          <xsl:element name="SerialIdentifier" namespace="http://inetprogram.org/projects/MDL">autogenerated</xsl:element>
          <xsl:element name="InventoryID" namespace="http://inetprogram.org/projects/MDL">autogenerated</xsl:element>
          <xsl:element name="Position" namespace="http://inetprogram.org/projects/MDL">9999</xsl:element>
          <xsl:element name="PositionsOccupied" namespace="http://inetprogram.org/projects/MDL">9999</xsl:element>
          ...
          <xsl:if test="not(/mdl:MDLRoot/mdl:NetworkDomains/mdl:Network/mdl:Device/mdl:Calibration)">
            <xsl:element name="Calibration" namespace="http://inetprogram.org/projects/MDL">
              <xsl:element name="CalibrationDate" namespace="http://inetprogram.org/projects/MDL">2000-01-01</xsl:element>
              <xsl:element name="CalibrationPair" namespace="http://inetprogram.org/projects/MDL">
                <xsl:element name="InputValue" namespace="http://inetprogram.org/projects/MDL">
                  <xsl:comment>Element "FlexValue" choosed from choices group</xsl:comment>
                  <xsl:element name="FlexValue" namespace="http://inetprogram.org/projects/MDL">9999</xsl:element>
                  <xsl:comment>Element "UnitsRef" choosed from choices group</xsl:comment>
                  <xsl:element name="UnitsRef" namespace="http://inetprogram.org/projects/MDL">
                    <xsl:attribute name="IDREF">
                      <xsl:value-of select="ancestor::mdl:UnitsType/@ID"/>
                    </xsl:attribute>
                  </xsl:element>
                </xsl:element>
          ...
          <xsl:element name="Children" namespace="http://inetprogram.org/projects/MDL">
            <xsl:element name="Child" namespace="http://inetprogram.org/projects/MDL">
              ...
              <xsl:element name="ChildRef" namespace="http://inetprogram.org/projects/MDL">
                <xsl:attribute name="IDREF">
                  <xsl:value-of select="ancestor::mdl:ChildType/@ID"/>
                </xsl:attribute>
              </xsl:element>
            </xsl:element>
          </xsl:element>
          <xsl:element name="Connector" namespace="http://inetprogram.org/projects/MDL">
            ...
            <xsl:element name="Pin" namespace="http://inetprogram.org/projects/MDL">
              ...
              <xsl:element name="Name" namespace="http://inetprogram.org/projects/MDL">autogenerated</xsl:element>
              <xsl:element name="Description" namespace="http://inetprogram.org/projects/MDL">autogenerated</xsl:element>
              <xsl:element name="Designator" namespace="http://inetprogram.org/projects/MDL">autogenerated</xsl:element>
              <xsl:element name="GenericParameter" namespace="http://inetprogram.org/projects/MDL">
                <xsl:element name="NameValues" namespace="http://inetprogram.org/projects/MDL">
                  <xsl:if test="/mdl:MDLRoot/mdl:NetworkDomains/mdl:N2NPortMapping/mdl:GenericParameter/mdl:NameValue">
                    <xsl:copy-of select="/mdl:MDLRoot/mdl:NetworkDomains/mdl:N2NPortMapping/mdl:GenericParameter/mdl:NameValue"/>
              ...
              <xsl:element name="DataOperationRefs" namespace="http://inetprogram.org/projects/MDL">
                ...
                <xsl:if test="not(/mdl:MDLRoot/mdl:NetworkDomains/mdl:Network/mdl:Device/mdl:DataOperationRef)">
                  <xsl:element name="DataOperationRef" namespace="http://inetprogram.org/projects/MDL">
                    <xsl:attribute name="IDREF">
                      <xsl:value-of select="ancestor::mdl:DataOperationType/@ID"/>
                    </xsl:attribute>
                  </xsl:element>
                </xsl:if>
              </xsl:element>
      ...
      <xsl:element name="InternalStructure" namespace="http://inetprogram.org/projects/MDL">
        ...
        <xsl:element name="Module" namespace="http://inetprogram.org/projects/MDL">
          ...
          <xsl:element name="NetworkInterface" namespace="http://inetprogram.org/projects/MDL">
            ...
            <xsl:element name="DHCPEnable" namespace="http://inetprogram.org/projects/MDL">true</xsl:element>
            <xsl:element name="PhysicalNetworkPort" namespace="http://inetprogram.org/projects/MDL">
              ...
              <xsl:element name="PortNumber" namespace="http://inetprogram.org/projects/MDL">9999</xsl:element>
              <xsl:element name="PortDataRate" namespace="http://inetprogram.org/projects/MDL">
                <xsl:element name="FloatValue" namespace="http://inetprogram.org/projects/MDL">9999</xsl:element>
                <xsl:comment>Element "UnitsRef" choosed from choices group</xsl:comment>
                <xsl:element name="UnitsRef" namespace="http://inetprogram.org/projects/MDL">
                  <xsl:attribute name="IDREF">
                    <xsl:value-of select="ancestor::mdl:UnitsType/@ID"/>
          ...
          <xsl:if test="not(/mdl:MDLRoot/mdl:NetworkDomains/mdl:Network/mdl:NetworkNode/mdl:Routes)">
            <xsl:element name="Routes" namespace="http://inetprogram.org/projects/MDL">
              <xsl:element name="Route" namespace="http://inetprogram.org/projects/MDL">
                <xsl:element name="Destination" namespace="http://inetprogram.org/projects/MDL">127.0.0.1</xsl:element>
                <xsl:element name="Netmask" namespace="http://inetprogram.org/projects/MDL">127.0.0.1</xsl:element>
                <xsl:comment>Element "NetworkInterfaceRef" choosed from choices group</xsl:comment>
                <xsl:element name="NetworkInterfaceRef" namespace="http://inetprogram.org/projects/MDL">
                  <xsl:attribute name="IDREF">
                    <xsl:value-of select="ancestor::mdl:NetworkInterfaceType/@ID"/>
                  </xsl:attribute>
                </xsl:element>
              </xsl:element>
            </xsl:element>
  ...
  <xsl:template match="/mdl:MDLRoot/mdl:NetworkDomains/mdl:Network/mdl:Antenna/mdl:SerialNumber">
    <xsl:element name="mdl:SerialIdentifier">
      <xsl:apply-templates select="@*|node()"/>
    </xsl:element>
  </xsl:template>
