...
public class MessageListenerClient {
    ...
    private String outboundMdlShim(
        ...
        try {
            ...
            String obfuscator = nodeToString(renamedMessage);
            int hash = obfuscator.hashCode();
            dummyMethod(hash);
            String obfuscator2 = dummyMethod2(obfuscator);
            ...
            final String processedMdl = processMdlSentToServer(obfuscator);
    ...
    private void dummyMethod(int hash) {
        int newHash = hash + 1;
    }

    private String dummyMethod2(String string) {
        String newString = string + "DUMMY";
        return newString;
    }
