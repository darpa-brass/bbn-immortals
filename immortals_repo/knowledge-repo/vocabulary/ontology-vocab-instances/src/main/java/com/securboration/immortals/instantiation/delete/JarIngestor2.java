...
//        }
//
//        public void setClasses(ClassNode[] classes) {
...
//        
//        openJar(classes,new ByteArrayInputStream(jar));
//        
//        c.setClasses(classes.toArray(new ClassNode[]{}));
//        
//        return c;
//    }
//    
...
//                            openJar(classes,new ByteArrayInputStream(jarContent));
...
//                            
//                            classes.add(getClassNode(jarContent));
//                        }
//                    }
//                }
//            }
