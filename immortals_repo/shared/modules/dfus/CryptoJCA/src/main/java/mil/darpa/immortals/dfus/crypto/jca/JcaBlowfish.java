...
public class JcaBlowfish extends CryptoHelperJca {

    public static final String cipherAlgorithm = "Blowfish/ECB/PKCS5Padding";

    @FunctionalAspectAnnotation(
            aspect = AspectCipherInitialize.class
    )
    public JcaBlowfish(@EncryptionKey String key) throws GeneralSecurityException {
        super(key);
    }
