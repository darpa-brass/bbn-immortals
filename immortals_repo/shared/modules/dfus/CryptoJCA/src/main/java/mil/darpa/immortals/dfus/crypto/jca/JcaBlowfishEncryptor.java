...
public class JcaBlowfishEncryptor extends JcaEncryptor {
    ...
    public JcaBlowfishEncryptor(@EncryptionKey String encryptionKey, @Output OutputStream consumer) {
        super(encryptionKey, JcaAes.cipherAlgorithm, consumer);
    }

    public JcaBlowfishEncryptor(@EncryptionKey String encryptionKey, @Output OutputStreamPipe consumer) {
        super(encryptionKey, JcaAes.cipherAlgorithm, consumer);
    }
}
