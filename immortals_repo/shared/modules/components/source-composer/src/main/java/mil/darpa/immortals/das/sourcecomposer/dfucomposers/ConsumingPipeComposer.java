...
import mil.darpa.immortals.configuration.sourcecomposer.paradigms.ConsumingPipeConfiguration;
import mil.darpa.immortals.configuration.sourcecomposer.paradigms.GenericParameterConfiguration;
...
import static mil.darpa.immortals.configuration.sourcecomposer.paradigms.GenericParameterConfiguration.parameterIroner;
...
public class ConsumingPipeComposer {
    ...
    public String createFieldDeclarationLine() throws CompositionException {
        ...
        if (compositionConfiguration.performAnalysis) {
            ...
            } else if (compositionConfiguration.applicationProfile.deploymentPlatform == DeploymentPlatform.Android) {
