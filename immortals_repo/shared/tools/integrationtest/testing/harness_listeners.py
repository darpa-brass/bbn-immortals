...
import integrationtest.threadprocessrouter as tpr
from integrationtest import immortalsglobals as ig
from integrationtest import resources
from integrationtest.datatypes.serializable import Serializable
from integrationtest.datatypes.testing import Phase2TestHarnessListenerInterface, Phase2SubmissionFlow, Phase2TestScenario
from integrationtest.generated.mil.darpa.immortals.core.api.ll.phase2.testadapterendpoint import TestAdapterEndpoint
from integrationtest.generated.mil.darpa.immortals.core.api.ll.phase2.testharnessendpoint import TestHarnessEndpoint
from integrationtest.testing.ta_submitter import produce_test_adapter_submissions, TestAdapterSubmission
        ...
        validators.append(
            NetworkExpectationValidator(
                ...
                submission_values={
                    ...
                    "validation.testsPassedPercent": test_scenario.expectedTestsPassedPercent
                },
                ack_values=None,
                ack_code=200
            )
    ...
    def __init__(self, done_listener: Callable, test_suite_identifier: str, test_identifier: str = None):
        ...
        if test_identifier is not None:
            self._scenario_executions.append(ScenarioExecution(
                test_scenario=Phase2TestScenario.from_dict(resources.get_test(test_identifier=test_identifier)),
                logger=self._logger))

        else:
            test_scenarios_d = resources.get_test_suite(test_suite_identifier)
