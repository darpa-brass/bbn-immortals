...
//			newAttributes.put("@class", gd.nodeType)
...
//			if (gd.parentData != null) {
//				Vertex childVertex = graphDataNewVertexMap.get(gd)
//				Vertex parentVertex = graphDataNewVertexMap.get(gd.parentData)
...
//		}).iterate()
//
//		System.out.println("Node Count: " + Long.toString(nodeCount))
//
...
//
//		System.out.println("Inserted Node Count: " + Long.toString(dauStructure.size()))
//	}
}
