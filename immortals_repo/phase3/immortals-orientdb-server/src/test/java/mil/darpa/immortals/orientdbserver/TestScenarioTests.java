...
public class TestScenarioTests {
	...
	public void generalTest() {
		TestScenario s5 = TestScenario.getScenario5TestScenario("s5DummyTest5BackupExists");
...
//		Assert.assertNull(s5.getXmlMdlrootInputPath());
		...
		s5 = TestScenario.getScenario5TestScenario("s5DummyTest5BackupDoesNotExist");
...
//		Assert.assertNotNull(s5.getXmlMdlrootInputPath());
		...
		TestScenario s6 = TestScenario.getScenario6TestScenario("s6DummyJsonInputInResources");
		Assert.assertNotNull(s6.getInputJsonData());

		s6 = TestScenario.getScenario6TestScenario("s6DummyJsonInputInResources");
		Assert.assertNotNull(s6.getInputJsonData());

		s6 = TestScenario.getScenario6TestScenario("s6DummyJsonFileAndResourceExists");
		Assert.assertNotNull(s6.getInputJsonData());
	}
}
