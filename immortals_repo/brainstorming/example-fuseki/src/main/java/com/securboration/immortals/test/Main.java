...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (args.length == 0) {
            System.err.printf(
                    "*** WARNING: expected exactly one arg, a URL to a "
    ...
    private Model getTestModel() throws IOException {
        return OntologyHelper.loadModel(this.getClass().getClassLoader()
                .getResourceAsStream("wine.rdf"), "RDF/XML");
    }
