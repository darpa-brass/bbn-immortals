...
public class OntologyHelper {
    ...
    public static void addMetadata(
        ...
        r.addLiteral(
                RDFS.comment, 
                "Automatically generated by the object-to-triples converter, Securboration Inc.");
    ...
    private static Property getPropertyForType(ObjectToTriplesConfiguration context,Model model,Type t,String fieldName){
...
//    }
    ...
    private static DataRange getRange(ObjectToTriplesConfiguration context, OntModel model, Type t){
    ...
    private static RDFNode analyzeType(ObjectToTriplesConfiguration context, OntModel model, Type t){
        ...
        for(Triple triple:triples){
            ...
            //get the subject
            {
                ...
                if(subjectClass != Constants.UndefinedClass.class){
                    s = getResourceForType(config,model,subjectClass);
                }
            ...
            //get the object
            {
                ...
                if(objectClass != Constants.UndefinedClass.class){
                    o = getResourceForType(config,model,objectClass);
                }
                ...
                if(o == null && !triple.objectLiteral().objectLiteralType().equals(Constants.UndefinedString)){
                    o = model.createTypedLiteral(
                            triple.objectLiteral().objectLiteral(), 
                            NodeFactory.getType(triple.objectLiteral().objectLiteralType()));
                }
