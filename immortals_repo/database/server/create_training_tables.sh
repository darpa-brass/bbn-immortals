...
warning="
IMPORTANT: Running this file will create query training tables in the das database.
This script assumes the baseline schema in the local Immortals database is populated.
