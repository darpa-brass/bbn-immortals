...
public class CommandLineParser {
    ...
    public CommandLineParser(String[] args) throws ParseException {
        ...
        options.addOption("jsonFile",true,"Immortals mutate script json file for run");
    ...
    public String getMutateScriptJsonFile(){return commandLine.getOptionValue("jsonFile");}
