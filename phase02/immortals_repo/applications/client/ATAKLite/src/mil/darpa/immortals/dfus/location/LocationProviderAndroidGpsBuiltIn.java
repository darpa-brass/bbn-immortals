...
public class LocationProviderAndroidGpsBuiltIn {
    ...
    public static boolean hasFineGrainedLocationPermission = false;
    ...
    private LocationListener locationListener = new LocationListener() {
        ...
        public void onLocationChanged(Location location) {
            Log.w("CP3-GPS", "Android Version: " + EnvironmentConfiguration.getAndroidEnvironment().getSimulatedndroidVersion());
            if (EnvironmentConfiguration.getAndroidEnvironment().getSimulatedndroidVersion() > 22 && !hasFineGrainedLocationPermission) {
                throw new RuntimeException("Location access requested without permission being granted!");
            }
