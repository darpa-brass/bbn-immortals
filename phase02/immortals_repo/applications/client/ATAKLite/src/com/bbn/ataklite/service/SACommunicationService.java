...
import mil.darpa.immortals.dfus.location.LocationProviderAndroidGpsBuiltIn;
...
public class SACommunicationService extends IntentService {
    ...
    LocationProviderAndroidGpsBuiltIn locationProvider = new LocationProviderAndroidGpsBuiltIn();
            ...
            public void run() {
                ...
                while (!interrupted) {
                    ...
                    if (coordinates != null) {
                        ...
                        CoTMessage message = new CoTMessage(CoordinateLocationConverter.toLocation(coordinates), config.callsign);
