...
public class ParameterizingSelectDeParser extends SelectDeParser {

    public ParameterizingSelectDeParser(ExpressionVisitor expressionVisitor, StringBuilder buffer) {
	...
	public void visit(PlainSelect plainSelect) {
		...
		ParameterizingExpressionDeParser expressionVisitor = (ParameterizingExpressionDeParser) super.getExpressionVisitor();
