...
import com.securboration.immortals.ontology.functionality.imageprocessor.AspectImageSuperAspect;
...
import com.securboration.immortals.ontology.functionality.alg.encryption.AspectHash;
import com.securboration.immortals.ontology.functionality.alg.encryption.Cipher;
import com.securboration.immortals.ontology.functionality.alg.encryption.HashFunction;
...
//        if(false)
    ...
    private static class Dfus{
        ...
        public static class SimpleAesCipher{
            ...
            public byte[] decrypt(
                ...
                return encrypt(data);
                //in an OTP scheme, encryption is the same as decryption
            }
            ...
            @Image
            public byte[] fileSysReceiveImage(@Image byte[] data) {
                        return new byte[1];
            }
            
            @FunctionalAspectAnnotation(aspect = AspectImageSuperAspect.class)
            @Image
            public byte[] fileSysRemoveBadImageProps(@Image byte[] data) {
                        return new byte[1];
            }
            ...
            @FileHandle
            public String fileSysWriteImage(@Image byte[] data) {
                        return null;
            }
            ...
            @BinaryData
            public byte[] fileSysDecryptImage(@BinaryData byte[] data) {
                return null;
            }
            
            public void sendToFileSystem(@BinaryData byte[] data) {
            }
            ...
            @Image
            public byte[] readImage(@FileHandle String path) {
                return null;
            }
            ...
            @FileHandle
            public String writeImage(@Image byte[] image) {
                return null;
            }
            ...
            @BinaryData
            public byte[] compressImage(@Image byte[] image) {
                // I AM COMPRESSING AN IMAGE!
                return image;
            }
            ...
            @Image
            public byte[] decompressImage(@BinaryData byte[] compressedImage) {
                return null;
            }
            ...
            @BinaryData
            public byte[] encryptImage(@BinaryData byte[] image) {
                return null;
            }
            ...
            @BinaryData
            public byte[] decryptImage(@BinaryData byte[] encryptedImage) {
                return null;
            }
            ...
            @Image
            public byte[] enlargeImage(@Image byte[] image) {
                // enlarge image
                return image;
            }
            ...
            public byte[] deflateImage(@Image byte[] image) {
                // deflate image
                return image;
            }
            
            public void sendToServer(@BinaryData byte[] data) {
            ...
            @BinaryData
            public byte[] clientEntry(@FileHandle String file) {
                return new byte[1];
            }
            
           // @BinaryData
           // public byte[] inflate(@Location String dummy, int dummy1, @BinaryData byte[] dataFromClient)
            
            
            @Image
            public byte[] serverEntry(@BinaryData byte[] dataFromClient, @Image int dummy, String dummy1) {
                
                Integer.bitCount(dummy);
                dummy1.substring(1);
                decrypt1(dataFromClient);
                Integer.decode(dummy1);
                return null;
            }
        }
    ...
    private static class BusinessLogic{
        ...
        public static class SaDataBuilder{
            ...
            public final Dfus.LocationGetter locationGetter;
