...
public class DfuInstance {
    ...
    @RdfsComment("Durable URI that will supersede the random URI generated by ObjectToTriples")
    private String durableUri;
    ...
    public String getDurableUri() {
        return durableUri;
    }

    public void setDurableUri(String durableUri) {
        this.durableUri = durableUri;
    }
}
