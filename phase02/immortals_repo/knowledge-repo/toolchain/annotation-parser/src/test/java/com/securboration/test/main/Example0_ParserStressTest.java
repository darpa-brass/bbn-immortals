...
@DfuAnnotation(
        ...
        resourceDependencyUris={
                "http://mil.darpa.immortals.satellites.gps.iridium#Iridium-1",
                "http://mil.darpa.immortals.satellites.gps.iridium#Iridium-2",
                "http://mil.darpa.immortals.satellites.gps.iridium#Iridium-3",
                "http://mil.darpa.immortals.satellites.gps.iridium#Iridium-4"
                }
        )
@Symmetric
public class Example0_ParserStressTest {
     ...
     */
    @FunctionalAspectAnnotation(
        aspect=CleanupAspect.class,
        resourceDependencyUris="http://mil.darpa.immortals.satellites.gps.iridium#Iridium-999",
        aspectSpecificResourceDependencies={GpsSatellite.class}
        )
