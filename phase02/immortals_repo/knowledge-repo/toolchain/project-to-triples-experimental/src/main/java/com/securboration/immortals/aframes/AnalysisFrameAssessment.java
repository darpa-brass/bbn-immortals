...
public class AnalysisFrameAssessment {
    ...
    public static List<AspectConfigureSolution> retrieveConfigurationSolutions(GradleTaskHelper taskHelper) throws Exception{
        ...
        // if (!configureSolutions.getSolutions().isEmpty()) {
        //  String aspectConfigureSolutionUUID = configureSolutions.getSolutions().get(0).get("configureSolution");
        //   AspectConfigureSolution configureSolution = (AspectConfigureSolution) TriplesToPojo.convert(taskHelper.getGraphName(), aspectConfigureSolutionUUID, taskHelper.getClient());
