...
public class DataflowTracker {
    ...
    //TODO: there can be more than one action for a given instruction if it is 
    // reachable along multiple control flow paths
    private final Map<AbstractInsnNode,Action> instructionsToActions = new HashMap<>();
    
    private final LocalVars locals;
    
    private final JavaValues valueEmulation;
    
    public DataflowTracker(
            ClassLoader cl,
            ClassNode cn,
            MethodNode mn,
            BasicBlock bbg,
        ...
        this.stackEmulator = new StackEmulator(this.bbg);
        this.locals = locals;
...
//        {
//            Map<AbstractInsnNode,List<Entry>> statesAfter = 
//                    this.stackEmulator.getStackStatesAfter();
//            
//            System.out.printf("\n\n--- stack emulation results ---\n");
//            for(AbstractInsnNode instruction:mn.instructions.toArray()){
//                System.out.printf(
//                    "b%-2d i%-3d: %s\n", 
//                    bbg.getBlock(instruction) == null ? -1 : bbg.getBlock(instruction).getBlockId(),
//                    mn.instructions.indexOf(instruction),
//                    MethodPrinter.print(mn,instruction)
//                    );
//                
//                List<Entry> stackState = statesAfter.get(instruction);
//                if(stackState == null){
//                    System.out.printf("\t??? stack state\n");
//                }else if(stackState.size() > 0){
//                    System.out.printf("\t%d stack entries:\n", stackState.size());
//                    for(Entry e:stackState){
//                        System.out.printf(
//                            "\t\t[%d] produced by i%d\n", 
//                            e.getId(), 
//                            mn.instructions.indexOf(e.getProducerInstruction())
//                            );
//                    }
//                }
//                
...
//        }//TODO
        ...
        {//TODO
            //ReachabilityAnalysis r = new ReachabilityAnalysis(mn,bbg);
            
            //System.out.println(r.printConnectivity(mn));
...
//        visitor.verifyVisitation(mn);
//        
        //TODO: dataflow analysis goes here
        
//        AbstractInsnNode head = this.bbg.getHead();
//        visit(
//            new DataflowAnalysisFrame(),
//            head
//            );
        
//        {//TODO
//            System.out.println("--- action analysis results ---");
...
//                    );
//                
//                Action a = instructionsToActions.get(i);
//                
//                if(a != null){
//                    System.out.printf("\t%s\n", a);
//                }
...
//        }
    ...
    public static class AnalysisVisitor implements IInstructionVisitor<DataflowTracker>{
        
//        private Actions getActions(DataflowTracker context, AbstractInsnNode i){
//            Actions a = context.instructionsToActions.get(i);
//            
//            if(a == null){
//                a = new Actions(i);
//                context.instructionsToActions.put(i, a);
//            }
//            
//            return a;
//        }
        
        private void setAction(DataflowTracker context, AbstractInsnNode i, Action a){
            if(context.instructionsToActions.containsKey(i)){
                throw new RuntimeException(
                    "action already defined for i" + 
                    context.mn.instructions.indexOf(i) + " " + 
                    MethodPrinter.print(context.mn, i)
                    );
            }
        ...
        /**
         * Sanity check to make sure that all instructions in the indicated
         * method were visited
         * 
         * @param mn
         */
        private void verifyVisitation(MethodNode mn){
            for(AbstractInsnNode i:mn.instructions.toArray()){
                if(!visited.contains(i)){
                    
                    throw new RuntimeException(
                        "sanity check failed, didn't visit " + 
                                MethodPrinter.print(mn,i)
                        );
                }
            }
        ...
        private final Set<AbstractInsnNode> visited = new HashSet<>();
        
        private void debug(
                AbstractInsnNode instruction,
                DataflowTracker context,
                String format,
                Object...args
                ){
...
//                }
        ...
        public void visitFrameInsnNode(
                ...
                DataflowTracker analysisContext
                ) {
        ...
        @Override
        public void pre(DataflowTracker context) {
//            if(false)
            {
        ...
        @Override
        public void post(DataflowTracker analysisContext) {
...
//            if(false)
    ...
    private BasicBlock getBlock(AbstractInsnNode instruction){
        return bbg.getBlock(instruction);
    }
    ...
    public Map<AbstractInsnNode, Action> getInstructionsToActions() {
        return instructionsToActions;
    }
